                    ...
                    <div class="mt-8 py-9">
                        ...
                        <div class="grid grid-cols-1 items-center gap-4 md:grid-cols-2">
                            ...
                            <form onsubmit="event.preventDefault()" class="flex flex-col p-6" method="post">
                                <input type="hidden" name="app_name" value="alurkerja" readonly
                                    class="input-form" />
                ...
                <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div class="grid place-items-center">
                            <div class="flex h-fit w-fit justify-center rounded-lg bg-white p-4">
                                <img src="{{ asset('images/AlurKerja.png') }}" class="text-center" alt="logo" />
                            </div>
                        </div>
                        <div>
